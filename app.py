...
# - Top-right Refresh button (no sidebar)
# - All figures right-aligned
# - Supplier Payments: Approved only
# - LC Settlements: Pending only + Remarks
# - Bank balances: table view (sum & share)
...
# ---------------------------------------------------------------------------
# Global CSS: right-align KPI values and hide sidebar just in case
# ---------------------------------------------------------------------------
st.markdown(
    """
    <style>
