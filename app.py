...
# Enhanced with interactive visualizations, animations, and modern UI
...
def render_enhanced_cards(df):
    """Render interactive animated cards"""
    ...
    for i, (_, row) in enumerate(df.iterrows()):
        with cols[i % 3]:
            ...
            # Handle after settlement if available
            ...
            if "after_settlement" in df.columns and pd.notna(row.get("after_settlement")):
                ...
                after_color = THEME["colors"]["danger"] if after_val < 0 else THEME["colors"]["success"]
                after_settlement_html = f"""
                <div style="margin-top: 15px; padding-top: 10px; border-top: 1px solid #e2e8f0;">
                    <div style="font-size: 0.9rem; color: #64748b; margin-bottom: 5px;">After Settlement</div>
